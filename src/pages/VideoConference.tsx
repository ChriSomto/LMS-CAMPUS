...
export default function VideoConference() {
  ...
  const validateForm = () => {
    ...
    if (!meetingName.length) {
      ...
      showErrorsClone.meetingName.message = ["Enter Lecture Subject"];
      errors = true;
    } else {
    ...
    if (!selectedUser.length && !anyoneCanJoin) {
      ...
      showErrorsClone.meetingUsers.message = ["Select Lecture Participants"];
      errors = true;
    } else {
  ...
  const createMeeting = async () => {
    if (!validateForm()) {
      ...
      createToast({
        title: anyoneCanJoin
          ? "Global Lecture meeting created successfully"
          : "Limited Lecture created successfully.",
        type: "success",
      });
      navigate("/");
    }
  ...
  return (
    ...
    >
      ...
      <EuiFlexGroup justifyContent="center" alignItems="center">
        <EuiForm>
          <EuiFormRow display="columnCompressedSwitch" label="Make Global">
            <EuiSwitch
              showLabel={false}
              label="Make Global"
