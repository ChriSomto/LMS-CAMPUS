      ...
      <EuiProvider colorMode={theme}>
        <EuiThemeProvider modify={overrides}>
          <Routes>
            ...
            <Route path="/createoneonone" element={<OneOnOneMeeting />} />
            <Route path="/multiplelecture" element={<VideoConference />} />
            <Route path="/mylectures" element={<MyMeetings />} />
            <Route path="/join/:id" element={<JoinMeeting />} />
            <Route path="/lectures" element={<Meeting />} />
